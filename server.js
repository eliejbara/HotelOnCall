                    ...
                    if (result.rowCount > 0) {
                        ...
                        db.query(
                            ...
                            (err) => {
                                ...
                                proceedWithCheckout(guest_id, room_number, feedback, res);
                            }
                        );
                    } else {
                        // If no cleaning requests, skip the update and continue with checkout
...
function proceedWithCheckout(guest_id, room_number, feedback, res) {
